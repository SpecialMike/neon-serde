...
#[doc(hidden)]
pub struct ArraySerializer<'a, 'j, C>
where
    C: Context<'j> + 'a,
{
    cx: &'a mut C,
...
#[doc(hidden)]
pub struct TupleVariantSerializer<'a, 'j, C>
where
    C: Context<'j> + 'a,
{
...
#[doc(hidden)]
pub struct MapSerializer<'a, 'j, C>
where
    C: Context<'j> + 'a,
{
    cx: &'a mut C,
...
#[doc(hidden)]
pub struct StructSerializer<'a, 'j, C>
where
    C: Context<'j> + 'a,
{
    cx: &'a mut C,
...
#[doc(hidden)]
pub struct StructVariantSerializer<'a, 'j, C>
where
    C: Context<'j> + 'a,
{
